...
This is version 2.2.1 of the Java NATS streaming library. This version is a port to version 2.x of the Java NATS library and contains breaking changes due to the way the underlying library handles exceptions, especially timeouts. For 2.1.6 we are renaming this repo to stan.java.
...
You can download the latest java nats streaming jar at [https://search.maven.org/remotecontent?filepath=io/nats/java-nats-streaming/2.2.1/java-nats-streaming-2.2.1.jar](https://search.maven.org/remotecontent?filepath=io/nats/java-nats-streaming/2.2.1/java-nats-streaming-2.2.1.jar).
